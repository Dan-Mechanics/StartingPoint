...
/// <summary>
/// IMPORTANT TODO: give credit to starting point and tuttorial code:
/// https://github.com/aaronvark/SFML-ImGui_StartPoint
/// https://github.com/VictorGordan/SFML-ImGUI
/// </summary>
/// <returns></returns>
int main()
{
